    ...
    return (
        <div className="max-w-md rounded-md shadow-md dark:bg-gray-900 dark:text-gray-100">
            ...
            <div className="flex flex-col justify-between p-6 space-y-8">
                ...
                <button type="button" className="flex items-center justify-center w-full p-3 font-semibold tracking-wide rounded-md bg-violet-700 text-gray-100 dark:bg-violet-700 dark:text-gray-900">Read more</button>
            </div>
        </div>
    );
};
