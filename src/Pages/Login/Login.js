        ...
        <section className="p-6 dark:bg-gray-800 dark:text-gray-100 w-4/12 mx-auto">
            <form onSubmit={handleLogin} className="self-stretch space-y-3 ng-untouched ng-pristine ng-valid">
                <div>
                    ...
                    <input id="name" type="email" placeholder="Your Email" className="w-full rounded-md focus:ring focus:ring-violet-400 dark:border-gray-700" />
                </div>
                <div>
                    <label htmlFor="lastname" className="text-sm sr-only">Email address</label>
                    <input id="lastname" type="password" placeholder="Your Password" className="w-full rounded-md focus:ring focus:ring-violet-400 dark:border-gray-700" />
                </div>
                <button type="button" className="w-full py-2 font-semibold rounded dark:bg-violet-400 dark:text-gray-900 bg-violet-700 text-gray-100">Login</button>
